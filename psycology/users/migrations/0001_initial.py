    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('books', models.ManyToManyField(blank=True, related_name='buyers', to='books.books')),
                ('courses', models.ManyToManyField(blank=True, related_name='students', to='courses.courses')),
